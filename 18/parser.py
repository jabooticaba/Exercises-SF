...
tree = etree.parse('18/Tele_bot/Welcome to Python.org.html', lxml.html.HTMLParser()) # попытаемся спарсить наш файл с помощью HTML-парсера. Сам HTML — это то, что мы скачали и поместили в папку из браузера.
...
for li in ul:
    ...
    b = li.find('time')  # в каждом элементе находим тэг <time>
    print(b.get('datetime'))  # из этого тега забираем ЗНАЧЕНИЕ АТРИБУТА datetime
