...
rawList = char_replacer(workString).split()  # Создаёт список из текста, пропущенного через функцию удаления символов пунктуации
...
print(list_max_word)  # Вывод максимально длинного английского слова
